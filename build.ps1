...
'@
$fragFiles = @('shaders/header.glsl','shaders/noise.glsl','shaders/terrain.glsl','shaders/weather-cloud-prelude.glsl','shaders/clouds.glsl','shaders/weather-cloud-visual.glsl','shaders/atmosphere.glsl','shaders/rings.glsl','shaders/fog.glsl','shaders/lightning.glsl','shaders/surface-artifact-prelude.glsl','shaders/surface.glsl','shaders/surface-artifact-postlude.glsl','shaders/sphere.glsl','shaders/thermal.glsl','shaders/main.glsl')
...
$TERRAINBAKE = "#version 300 es`n" + ((@('shaders/header.glsl','shaders/noise.glsl','shaders/terrain.glsl','shaders/terrain-bake.glsl') | ForEach-Object { Read-Utf8Strict (Join-Path $DIR $_) }) -join "`n")
...
$jsFiles = @('js/gl-init.js','js/math.js','js/hydrology.js','js/state.js','js/procedural-synoptic-retirement.js','js/camera.js','js/magnetosphere.js','js/magnet-axis-rotation.js','js/touch-ux.js','js/ui.js','js/rubric-grid.js','js/ui-toggle-layout.js','js/cloud-visibility-controls.js','js/planet-physics.js','js/star-orbit.js','js/orbit-eccentricity.js','js/param-model.js','js/screenshot.js','js/atmosphere-inventory.js','js/volcanic-atmosphere-coupling.js','js/water-budget.js','js/climate-regimes.js','js/extreme-orbit-physics.js','js/stellar-weather-coupling.js','js/habitable-random.js','js/weather-core.js','js/weather-regime-rebase.js','js/temperature-diagnostics.js','js/weather-target-smoothing.js','js/orographic-lift.js','js/local-energy-balance.js','js/diurnal-cycle.js','js/seasons.js','js/eccentric-seasons.js','js/baric-field.js','js/wind-dynamics.js','js/h2o-advection.js','js/h2o-column-thermodynamics.js','js/condensation.js','js/precipitation.js','js/soil-hydrology.js','js/weather-fronts.js','js/pressure-systems.js','js/deep-convection.js','js/vertical-stability.js','js/deep-convection-coupling.js','js/cloud-radiative-feedback.js','js/ocean-thermal.js','js/cryosphere.js','js/ocean-circulation.js','js/ocean-heat-transport.js','js/atmospheric-heat-transport.js','js/polar-surface-thermodynamics.js','js/polar-continentality.js','js/cryosphere-sublimation.js','js/river-physics.js','js/river-routing-refinement.js','js/river-visual-tributaries.js','js/physical-fog.js','js/fog-spatial-fix.js','js/weather-audit-diagnostics.js','js/lightning-weather.js','js/cloud-visual-response.js','js/resolved-lift-clouds.js','js/river-gpu.js','js/weather-cloud-gpu.js','js/fog-gpu.js','js/fog-skin-temperature.js','js/cryosphere-gpu.js','js/cryosphere-edge-display.js','js/planet-export.js','js/planet-share-activation.js','js/render.js','js/orbit-overlay.js','js/orbit-overlay-drag.js','js/orbit-scene-path.js','js/ecliptic-overlay.js','js/thermal-display.js','js/thermal-probe.js','js/runtime-settings.js','js/presentation-clock.js','js/weather-frame-budget.js','js/weather-cloud-render.js','js/river-render.js','js/terrain-bake.js','js/river-drainage-fine.js','js/fog-render.js','js/cryosphere-render.js','js/smooth-motion-ui.js','js/climate-consistency.js','js/habitable-random-thermal-fix.js','js/input-frame-pacing.js','js/frame-pacing-polish.js','js/river-frame-pacing.js','js/screenshot-trigger.js','js/pause-ui.js','js/mobile-portrait-layout.js','js/celsius-ui.js','js/weather-worker.js')
...
[void]$sb.AppendLine('const TERRAIN_BAKE_FRAG = `'+$TERRAINBAKE+'`;')
