...
'@
$fragFiles = @('shaders/header.glsl','shaders/noise.glsl','shaders/terrain.glsl','shaders/weather-cloud-prelude.glsl','shaders/clouds.glsl','shaders/weather-cloud-visual.glsl','shaders/atmosphere.glsl','shaders/rings.glsl','shaders/fog.glsl','shaders/lightning.glsl','shaders/surface-artifact-prelude.glsl','shaders/river-channels.glsl','shaders/surface.glsl','shaders/surface-artifact-postlude.glsl','shaders/sphere.glsl','shaders/thermal.glsl','shaders/main.glsl')
