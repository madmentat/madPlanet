...
$jsFiles = @('js/gl-init.js','js/math.js','js/hydrology.js','js/state.js','js/camera.js','js/magnetosphere.js','js/touch-ux.js','js/ui.js','js/planet-physics.js','js/star-orbit.js','js/param-model.js','js/screenshot.js','js/atmosphere-inventory.js','js/water-budget.js','js/render.js')
