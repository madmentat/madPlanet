...
assert.ok(buildPs.includes("'js/atmosphere-inventory.js','js/water-budget.js','js/climate-regimes.js','js/render.js'"),
  'PowerShell build must load climate after atmosphere+water and before render');
assert.ok(buildSh.includes('js/atmosphere-inventory.js js/water-budget.js js/climate-regimes.js js/render.js'),
  'shell build must load climate after atmosphere+water and before render');
