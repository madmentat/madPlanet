...
assert.ok(buildPs.includes("'js/atmosphere-inventory.js','js/water-budget.js','js/render.js'"),
  'PowerShell build must load water budget after atmosphere inventories and before render');
assert.ok(buildSh.includes('js/atmosphere-inventory.js js/water-budget.js js/render.js'),
  'shell build must load water budget after atmosphere inventories and before render');
