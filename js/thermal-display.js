/* ============ 0.5.117 / 0.5.120: thermal imager display mode ============ */
(function installThermalDisplay(){
  ...
  style.textContent=`
    ...
    #thermalLegend.on{display:block}.thermal-scale{height:8px;border-radius:5px;background:linear-gradient(90deg,rgb(20,3,38) 0%,rgb(20,31,158) 20%,rgb(0,194,230) 42%,rgb(250,230,31) 64%,rgb(245,46,8) 84%,rgb(255,247,229) 100%)}
