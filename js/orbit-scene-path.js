/* ============ 0.5.118 / 0.5.121 / 0.5.122 / 0.5.125: stabilized physical orbit HUD ============ */
/*
   Main-scene orbit is navigation symbology, not astronomical scale: the major
   axis stays fixed in screen space so zoom cannot make the guide explode or
   collapse. Its SHAPE, focus, current position and Kepler timing, however, all
   use the real seeded orbital eccentricity. 0.5.124's readability-only visual
   eccentricity exaggeration is deliberately removed.

   The current planet is forced to exact screen centre every frame. The
   schematic sun is drawn last at the real displayed focus, naturally
   occluding the line behind it.
*/
