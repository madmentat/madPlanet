...
$(cat "$DIR/shaders/weather-cloud-prelude.glsl")
$(cat "$DIR/shaders/clouds.glsl")
$(cat "$DIR/shaders/weather-cloud-visual.glsl")
...
TERRAIN_BAKE_FRAG="#version 300 es
$(cat "$DIR/shaders/header.glsl")
$(cat "$DIR/shaders/noise.glsl")
$(cat "$DIR/shaders/terrain.glsl")
$(cat "$DIR/shaders/terrain-bake.glsl")"
